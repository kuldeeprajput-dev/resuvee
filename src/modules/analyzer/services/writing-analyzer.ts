...
const VALID_VOCABULARY = new Set([
  ...
  "a", "an", "the", "and", "or", "but", "if", "in", "on", "at", "to", "for", "with", "by", "from",
  "up", "of", "about", "into", "over", "after", "through", "during", "before", "under", "between",
  "is", "are", "was", "were", "be", "been", "being", "have", "has", "had", "do", "does", "did",
  "can", "could", "will", "would", "shall", "should", "may", "might", "must",
  "i", "you", "he", "she", "it", "we", "they", "my", "your", "his", "her", "its", "our", "their",
  "this", "that", "these", "those", "who", "whom", "whose", "which", "what", "where", "when", "how",
  "senior", "junior", "lead", "principal", "manager", "director", "vice", "president", "head",
  "engineer", "developer", "architect", "designer", "consultant", "analyst", "administrator",
  "specialist", "coordinator", "executive", "officer", "associate", "intern", "trainee", "fellow",
  "program", "project", "product", "team", "group", "department", "organization", "company",
  "years", "year", "month", "months", "experience", "background", "track", "record", "history",
  "delivering", "delivered", "deliver", "delivers", "development", "developing", "developed",
  "management", "managing", "managed", "business", "critical", "initiatives", "across",
  "technology", "operations", "customer", "experience", "service", "support", "sales", "marketing",
  "strategy", "strategic", "planning", "execution", "performance", "growth", "revenue", "profit",
  "data", "analytics", "analysis", "system", "systems", "platform", "platforms", "solution",
  "solutions", "architecture", "design", "implementation", "integration", "automation", "process",
  "processes", "quality", "assurance", "testing", "security", "cloud", "infrastructure", "devops",
  "software", "web", "mobile", "frontend", "backend", "fullstack", "full-stack", "database",
  "code", "coding", "technical", "agile", "scrum", "kanban", "leadership", "mentorship",
  "collaboration", "cross-functional", "communication", "stakeholder", "client", "customer",
  "results", "impact", "driven", "focused", "proven", "successful", "key", "core", "primary",
  "main", "major", "scale", "scaled", "scaling", "scalable", "optimize", "optimized", "optimizing",
  "improved", "improving", "improvement", "increased", "increasing", "increase", "reduced",
  "reducing", "reduction", "saved", "saving", "built", "building", "created", "creating",
  "launched", "launching", "spearheaded", "orchestrated", "led", "leading", "directed",
  "established", "implemented", "transformed", "designed", "engineered", "crafted",
  "know", "knew", "known", "work", "worked", "working", "duty", "duties", "task", "tasks",
  "role", "roles", "title", "job", "career", "professional", "summary", "skills", "tools",
  "education", "certifications", "degree", "bachelor", "master", "doctorate", "phd", "university",
  "college", "institute", "school", "science", "arts", "business", "computer", "information",
  "boston", "new", "york", "san", "francisco", "chicago", "london", "redwood", "atlas", "group",
  "services", "tech", "corp", "inc", "ltd", "llc", "co", "member", "society", "award", "honors",
]);
...
export function analyzeLocalWritingFallback(targets: WritingTarget[]): WritingCheckResponse {
  ...
  const COMMON_RULES: [RegExp, string, WritingIssueType, string][] = [
    ...
    [/\bwas responsible for\b/i, "directed", "clarity", "Replaces passive phrasing with an executive action verb."],
    [/\bworked on\b/i, "developed and delivered", "clarity", "Replaces weak phrasing with a result-oriented action verb."],
    [/\bhelped with\b/i, "collaborated to execute", "clarity", "Strengthens bullet point impact with active phrasing."],
    [/\bhandled\b/i, "orchestrated", "clarity", "Uses a concise, proactive action verb."],
    [/\bin charge of\b/i, "managed and directed", "clarity", "Replaces informal phrasing with an executive action verb."],
    [/\btasked with\b/i, "commissioned to lead", "clarity", "Replaces passive assignment phrasing with active leadership."],
    [/\bduty was to\b/i, "driven to achieve", "clarity", "Replaces job-duty language with impact-focused action."],
...
export async function analyzeResumeWriting(
  ...
  try {
    ...
    localIssues.forEach((localItem) => {
      if (!combined.some((c) => c.targetId === localItem.targetId && c.original === localItem.original)) {
