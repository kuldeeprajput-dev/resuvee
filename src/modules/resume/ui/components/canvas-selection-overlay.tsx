...
export function CanvasSelectionOverlay({ highlightRect }: CanvasSelectionOverlayProps) {
  if (!highlightRect || highlightRect.width <= 0 || highlightRect.height <= 0) return null;

  return (
    <div
      className="no-print pointer-events-none absolute z-30 hidden lg:block rounded-2xl border-2 border-[#059669] bg-emerald-500/10 transition-all duration-150 ease-out animate-in fade-in"
      style={{
