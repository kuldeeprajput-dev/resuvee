  ...
  return (
    <div className="no-print fixed inset-0 z-300 flex justify-end bg-black/15">
      ...
      <aside
        ...
        className="relative flex h-full w-full min-w-[320px] sm:min-w-[520px] max-w-[95vw] flex-col overflow-hidden bg-(--brand-canvas) shadow-2xl"
      >
        <div
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5 sm:p-7">
          <label htmlFor="job-description" className="text-sm font-bold text-(--brand-ink)">
          ...
          {!result.keywordCount ? (
            ...
            <>
              <div className="mt-5 grid gap-3 sm:grid-cols-[130px_1fr]">
                <div className="flex flex-col items-center justify-center rounded-2xl border border-emerald-500/25 bg-linear-to-br from-emerald-50/90 via-white to-emerald-50/50 p-5 shadow-2xs">
                ...
                <div className="rounded-2xl border border-black/10 bg-white p-4 shadow-2xs">
                  <p className="text-xs font-bold text-(--brand-ink)">What this means</p>
              ...
              <section className="mt-6">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {result.matched.length ? (
                    ...
                    <p className="text-xs text-(--brand-muted)">No strong keyword overlap yet.</p>
                  )}
                </div>
              </section>
              ...
              <section className="mt-6">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-(--brand-ink)">Consider adding</h3>
                  </div>
                  {suggested.length > 1 && (
                    <button
                      type="button"
                ...
                <div className="mt-3 space-y-2">
                  {suggested.map((keyword) => (
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-xl border border-black/10 bg-white px-3.5 py-3 text-left text-xs font-bold text-(--brand-ink) transition hover:border-emerald-500 hover:bg-emerald-50/50 shadow-2xs cursor-pointer"
                    >
